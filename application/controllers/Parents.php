...
class Parents extends CI_Controller
{
    ...
    function announcements($param1 = '', $param2 = '', $param3 = '')
    {
        if ($this->session->userdata('parent_login') != 1)
            redirect(base_url(), 'refresh');
        $page_data['teachers']   = $this->db->get('teacher')->result_array();
        $page_data['page_name']  = 'announcements';
    ...
    function tasks($param1 = '', $param2 = '', $param3 = '')
    {
        if ($this->session->userdata('parent_login') != 1)
            redirect(base_url(), 'refresh');
        $page_data['teachers']   = $this->db->get('teacher')->result_array();
        $page_data['page_name']  = 'tasks';
        $page_data['page_title'] = get_phrase('tasks');
        $this->load->view('backend/index', $page_data);
    }

    function my_settings($param1 = '', $param2 = '', $param3 = '')
    {
        if ($this->session->userdata('parent_login') != 1)
            redirect(base_url(), 'refresh');
        $page_data['teachers']   = $this->db->get('teacher')->result_array();
        $page_data['page_name']  = 'my_settings';
        $page_data['page_title'] = get_phrase('my_settings');
        $this->load->view('backend/index', $page_data);
    }

    function observer_dashboard($param1 = '', $param2 = '', $param3 = '')
    {
        if ($this->session->userdata('parent_login') != 1)
            redirect(base_url(), 'refresh');
        $page_data['teachers']   = $this->db->get('teacher')->result_array();
        $page_data['page_name']  = 'observer_dashboard';
        $page_data['page_title'] = get_phrase('observer_dashboard');
        $this->load->view('backend/index', $page_data);
    }

    function goals($param1 = '', $param2 = '', $param3 = '')
    {
        if ($this->session->userdata('parent_login') != 1)
            redirect(base_url(), 'refresh');
        $page_data['teachers']   = $this->db->get('teacher')->result_array();
        $page_data['page_name']  = 'goals';
        $page_data['page_title'] = get_phrase('goals');
        $this->load->view('backend/index', $page_data);
    }
