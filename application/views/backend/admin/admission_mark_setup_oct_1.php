                    ...
                    <div class="padded">
                        <div class="form-group">
                            <table class="border_new test">
                                ...
                                <tbody>
                                <?php
                                $allstds12 = $this->db->get('admission_mark_setup')->result_array();
                                foreach($allstds12 as $row14):
                                    ?>
                                    <tr>
                                        <td><input type="text" class="form-control" name="id[]" value="<?php echo $row14['id'];?>"/></td>
                                        <td><input type="text" class="form-control" name="name[]" value="<?php echo $row14['name'];?>"/></td>
                                        <td><input type="text" class="form-control" name="physics" value="<?php echo $row14['physics'];?>"/></td>
                                        <td><input type="text" class="form-control" name="chemistry" value="<?php echo $row14['chemistry'];?>"/></td>
                                        <td><input type="text" class="form-control" name="mathmatics" value="<?php echo $row14['mathmatics'];?>"/></td>
                                        <td><input type="text" class="form-control" name="english" value="<?php echo $row14['english'];?>"/></td>
                                        <td><input type="text" class="form-control" name="previous_exam" value="<?php echo $row14['previous_exam'];?>"/></td>
                                        <td><input type="text" class="form-control" name="obtained_mark" value="<?php echo $row14['obtained_mark'];?>"/></td>
                                        <td><input type="text" class="form-control" name="total_mark" value="<?php echo $row14['total_mark'];?>"/></td>
                                        <td><input type="text" class="form-control" name="position" value="<?php echo $row14['position'];?>"/></td>
                                    </tr>
                                    <?php
                                endforeach;
                                ?>
                                ...
                                $allstds = $this->db->get('osad_student_12')->result_array();
                                foreach($allstds as $row12):
                                    ?>
                                    <tr>
                                        <td><input type="text" class="form-control" name="id[]" value="<?php echo $row12['id'];?>"/></td>
