<div class="row">
	<div class="col-md-12">
		<?php echo form_open(base_url() . 'index.php?admin/students_list_program_semester' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>

		<div class="col-sm-3">
			<select name="NameofProgram" class="form-control">
		...
		<div class="col-sm-3">
			<select name="StdStatus" class="form-control">
		...
		<div class="col-sm-3">
			<select name="Session" class="form-control">
				...
				foreach($ss as $rss2):
					?>
					<option value="<?php echo $rss2['id'];?>">
						<?php echo $rss2['SessionName']." (".$rss2['SemesterDuration'].")";?>
					</option>
					<?php
				endforeach;
				?>
