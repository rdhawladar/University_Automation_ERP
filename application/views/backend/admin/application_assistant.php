        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="entypo-menu"></i>
                    <?php echo get_phrase('application_research_assistant');?>
                </a></li>
            <li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                <table cellpadding="0" cellspacing="0" border="0" class="table table-bordered datatable" id="table_export">
                    ...
                    <tr>
                        ...
                        <th><div><?php echo get_phrase('research_assistant_topic');?></div></th>
                        <th><div><?php echo get_phrase('research_assistant_description');?></div></th>
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    ...
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('research_assistant_topic');?></label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="notice_title"/>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('research_assistant_description');?></label>
                        <div class="col-sm-5">
                            <textarea class="form-control" name="notice_title"/> </textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('research_assistant_reference');?></label>
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="notice_title"/>
                            <input type="file">
                        </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info"><?php echo get_phrase('research_request');?></button>
                        </div>
                    </div>
                    </form>
                </div>
