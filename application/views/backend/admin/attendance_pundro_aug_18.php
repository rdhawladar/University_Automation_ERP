            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    ...
                    <div class="padded">
                        ...
                        <div class="form-group">
                            <label class="control-label"><?php echo get_phrase('student_roll');?></label>
                            <div class="col-sm-5">
                                <select name="StdRoll" class="form-control">
                                    <option value="#"><?php echo get_phrase('select');?></option>
                                    <?php
                                    $c_pr = $this->db->get('applicants_details')->result_array();
                                    foreach($c_pr as $row22v):
                                        ?>
                                        <option value="<?php echo $row22v['id'];?>">
                                            <?php echo $row22v['ClassRollNo']. " - " .$row22v['NameofApplicant'];?>
                                        </option>
                                        <?php
                                    endforeach;
                                    ?>
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo get_phrase('attendance_status');?></label>
                            <div class="col-sm-5">
                        ...
                        <!--<div class="form-group">
                            <label class="col-sm-3 control-label"><?php /*echo get_phrase('signature_of_course_instructor');*/?></label>
                            <div class="col-sm-5">
                                <input type="file" class="form-control" name="SignatureCourseInstructor"/>
                            </div>
                        </div>-->
                        <div class="form-group">
