        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="entypo-menu"></i>
                    <?php echo get_phrase('online_coursework_marks_entry');?>
                </a></li>
            <li>
                        ...
                        <div class="form-group">
                            <table class="table table-bordered datatable" id="table_export">
                                ...
                                <tr>
                                    <th><div>#</div></th>
                                    <th><div><?php echo get_phrase('roll_no');?></div></th>
                                    <th><div><?php echo get_phrase('maximum_number');?></div></th>
                                    <th><div><?php echo get_phrase('obtained_mark');?></div></th>
                                    <th><div><?php echo get_phrase('attendance_mark');?></div></th>
                                    <th><div><?php echo get_phrase('comment');?></div></th>
                                </tr>
                                </thead>
                                <tbody>
                                <?php 
                                $allstds = $this->db->get('exam_enter_marks')->result_array();
                                $count = 1;foreach($allstds as $row43):?>
                                    <tr>
                                        <td><?php $count++;?></td>
                                        <td><input type="text" class="form-control" name="personal_roll_no[]" value="<?php echo $row43['personal_roll_no'];?>"/></td>
                                        <td><input type="text" class="form-control" name="max_mark[]" value="<?php echo $row43['max_mark'];?>"/></td>
                                        <td><input type="text" class="form-control" name="obt_mark" value="<?php echo $row43['obt_mark'];?>"/></td>
                                        <td><input type="text" class="form-control" name="attn_mark" value="<?php echo $row43['attn_mark'];?>"/></td>
                                        <td><input type="text" class="form-control" name="comment" value="<?php echo $row43['comment'];?>"/></td>
                                    </tr>
                                <?php endforeach;?>
                                </tbody>
                            </table>
