        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="entypo-menu"></i>
                    <?php echo get_phrase('exam_set_grade_scale');?>
                </a></li>
            <li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tr>
                        ...
                        <th><div><?php echo get_phrase('lower_mark_range(in_%)');?></div></th>
                        <th><div><?php echo get_phrase('upper_mark_range(in_%)');?></div></th>
                    ...
                    <?php $count = 1;foreach($acdSession as $row):?>
                        <tr>
                            ...
                            <td>
                                <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_exam_set_grade_scale/<?php echo $row['id'];?>');">
                                    <i class="entypo-pencil"></i>
                                    <?php echo get_phrase('edit');?>
                                </a>
                                &nbsp;  &nbsp;  &nbsp;
                                <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/exam_set_grade_scale/delete/<?php echo $row['id'];?>');">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?admin/exam_set_grade_scale/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                    <div class="padded">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-info"><?php echo get_phrase('add_exam_set_grade_scale');?></button>
                            </div>
                        </div>
                    </form>
                </div>
