        ...
        <div class="tab-content">
                ...
                <div id="content">
                    ...
                    <div class="box" id="saveFormDiv" style="display: none;">
                        ...
                        <div class="inner">
                            ...
                            <form name="frmSave" id="frmSave" method="post" action="/hrm/symfony/web/index.php/admin/viewLicenses">

                                <input type="hidden" name="license[_csrf_token]" value="f92cde55a2e6815b9bb76ad3f0331482" id="license__csrf_token">
                                <input type="hidden" name="license[id]" value="" id="license_id">
                                <fieldset>

                                    <ol>

                                        <li>
                                            <label for="license_name">Name <em>*</em></label>                        <input type="text" name="license[name]" class="block default editable valid" maxlength="100" id="license_name">                    </li>
                    ...
                    <div id="recordsListDiv" class="box miniList">
                        ...
                        <div class="inner">
                            ...
                            <form name="frmList" id="frmList" method="post" action="/hrm/symfony/web/index.php/admin/deleteLicenses">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box" id="saveFormDiv" style="display: block;">
                    <div class="head">
                        <h1 id="saveFormHeading">Add License</h1>
                    </div>
