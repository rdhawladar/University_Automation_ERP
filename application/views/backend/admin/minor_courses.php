        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="entypo-menu"></i>
                    <?php echo get_phrase('minor_courses');?>
                </a></li>
            <li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tr>
                        ...
                        <th><div><?php echo get_phrase('minor');?></div></th>
                    ...
                    <?php $count = 1;foreach($acdSession as $row):?>
                        <tr>
                            ...
                            <td><?php echo "yes";?></td>
                            <td>
                                <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_minor_courses/<?php echo $row['id'];?>');">
                                    <i class="entypo-pencil"></i>
                                    <?php echo get_phrase('edit');?>
                                </a>
                                &nbsp;  &nbsp;  &nbsp;
                                <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/minor_courses/delete/<?php echo $row['id'];?>');">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?admin/minor_courses/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                    <div class="padded">
                        ...
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo get_phrase('minor');?></label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" name="minor_subjects" value="yes" readonly/>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info"><?php echo get_phrase('add_minor_courses');?></button>
                        </div>
                    </div>
                    </form>
                </div>
