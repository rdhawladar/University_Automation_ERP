<?php 
$edit_data		=	$this->db->get_where('admission_configuration' , array('id' => $param2) )->result_array();
		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo get_phrase('edit_admission_configuration');?>
            	</div>
            </div>
			<div class="panel-body">

                <?php echo form_open(base_url() . 'index.php?admin/admission_configuration/do_update/'.$row['id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="AdmissionType" id="" class="form-control">
                            <option value="<?php echo $row['AdmissionType'];?>"><?php echo $row['AdmissionType'];?></option>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="datepicker form-control" name="AdmissionDate" value="<?php echo $row['AdmissionDate'];?>"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo get_phrase('admission_time');?></label>
                    <div class="col-sm-5">
                        <input type="text" class="form-control" name="AdmissionTime" value="<?php echo $row['AdmissionTime'];?>"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo get_phrase('admission_start_date');?></label>
                    <div class="col-sm-5">
                        <input type="text" class="datepicker form-control" name="AdmissionStartDate" value="<?php echo $row['AdmissionStartDate'];?>"/>
                    </div>
                </div>
                <div class="form-group">
                    <label class="col-sm-3 control-label"><?php echo get_phrase('admission_end_date');?></label>
                    <div class="col-sm-5">
                        <input type="text" class="datepicker form-control" name="AdmissionEndDate" value="<?php echo $row['AdmissionEndDate'];?>"/>
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select name="IsActive" id="">
                            <option value="<?php echo $row['IsActive'];?>"><?php echo $row['IsActive'];?></option>
            		...
            		<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo get_phrase('edit_admission_configuration');?></button>
						</div>
					</div>
        		</form>
            </div>
