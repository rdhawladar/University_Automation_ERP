<?php 
$edit_data		=	$this->db->get_where('exam_enter_assessment_mark' , array('id' => $param2) )->result_array();
		...
		<div class="panel panel-primary" data-collapsed="0">
        	<div class="panel-heading">
            	<div class="panel-title" >
					...
					<?php echo get_phrase('edit_exam_enter_assessment_mark');?>
            	</div>
            </div>
			<div class="panel-body">

                <?php echo form_open(base_url() . 'index.php?admin/exam_enter_assessment_mark/do_update/'.$row['id'] , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                ...
                <div class="form-group">
            		...
            		<div class="form-group">
						<div class="col-sm-offset-3 col-sm-5">
							<button type="submit" class="btn btn-info"><?php echo get_phrase('edit_exam_enter_assessment_mark');?></button>
						</div>
					</div>
        		</form>
            </div>
