            ...
            <div class="tab-pane box active onad" id="list">
				<div class="row">
					<div class="col-md-12 shortlist">
								...
								<div class="padded">
									...
									<div class="form-group">
										<div class="col-md-8" class="floatright">
											<input type="text" name="AdmissionRollNo" placeholder="reference_no"/>
										</div>
						...
						<div class="col-md-1">
							<a href="<?php echo base_url() . 'index.php?admin/online_admission/shortlisted_candidates/3';?>">
								<?php echo get_phrase('short_list');?>
							</a> &nbsp;&nbsp;&nbsp;
							<a href="<?php echo base_url() . 'index.php?admin/online_admission/rejected_candidates/4';?>">
						...
						<div class="inner-wrap">
							<table>
								<tr>
									<td>
										<div class="form-group">
											<label for="field-2" class="col-sm-3 control-label"><?php echo get_phrase('reference_number');?></label>
						...
						<div class="inner-wrap">
							...
							<div class="inner-wrap"><table>
									<tr>
										...
										<td><label>Date of Birth(mm-dd-yy): <input type="date" class="datepicker" name="ApplicantBirthDate" id="ApplicantBirthDate"/></label></td></tr>
							...
							<div class="inner-wrap"><h3>Present Address</h3><table>
									...
									<tr><td><label>Village <input type="text" name="PresentVillage" id = "PresentVillage" /></label></td>
										<td><label>Mobile No <input readonly type="text" name="PresentMobile" id = "PresentMobile" /></label></td></tr>
									...
									<tr><td><label>Pollice Station <input type="text" name="PresentPoliceStation" id="PresentPoliceStation"/></label></td>
										<td><label>E-mail <input type="text" readonly name="PresentEmail" /></label></td></tr>
							...
							<div class="inner-wrap acdqual">
								<table>
									<tr><td><label>Certificate/Degree
										...
										<td><label>Institute <input type="text" name="CertificateNameofInstitute1" id="CertificateNameofInstitute1"/></label></td>
										<td><label>Board <input type="text" name="CertificatePointsObtained1"/></label></td>
										<td><label>GPA <input type="text" name="CertificateCGPA1" id="CertificateCGPA1"/></label></td>
							...
							<div class="inner-wrap acdqual">
								<table>
									<tr><td><label>Certificate/Degree
										...
										<td><label>Institute <input type="text" name="CertificateNameofInstitute2" id="CertificateNameofInstitute2"/></label></td>
										<td><label>Board <input type="text" name="CertificatePointsObtained2"/></label></td>
										<td><label>GPA <input type="text" name="CertificateCGPA2" id="CertificateCGPA2"/></label></td>
				   ...
				   <input type="checkbox" name="terms12" value="check" id="terms12">You agree to our Terms and Policy.
								...
								<table>
									<tr>
										...
										<td colspan="2"><label>Date<input type="date" class="datepicker" name="ApplicationDate" id="ApplicationDate"/></label></td>
									</tr>
								</table>
							</div>
					</div>
