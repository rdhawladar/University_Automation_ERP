            ...
            <div class="tab-pane box active onad" id="list">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tr>
                        ...
                        <th><div><?php echo get_phrase('visa_period');?></div></th>
                        <th><div><?php echo get_phrase('visa_expired_date');?></div></th>
                        <th><div><?php echo get_phrase('visa_renew');?></div></th>
                    ...
                    <?php $count = 1;foreach($osadStudent as $row):?>
                        <tr>
                            ...
                            <td><?php echo $row['visaperiod'];?></td>
                            <td><?php echo $row['visaexpireddate'];?></td>
                            <td><?php echo $row['visarenew'];?></td>
                            <td>
                                <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_renewal_of_visa/<?php echo $row['student_id'];?>');">
