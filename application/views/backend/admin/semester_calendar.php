        ...
        <ul class="nav nav-tabs bordered">
            <li class="active">
                <a href="#list" data-toggle="tab"><i class="entypo-menu"></i>
                    <?php echo get_phrase('semester_calendar');?>
                </a></li>
            <li>
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tr>
                        ...
                        <th><div><?php echo get_phrase('semester_start_date');?></div></th>
                        <th><div><?php echo get_phrase('semester_end_date');?></div></th>
                        <th><div><?php echo get_phrase('seat_count');?></div></th>
                    ...
                    <?php $count = 1;foreach($acdSession as $row):?>
                        <tr>
                            ...
                            <td><?php echo $row['SemesterStartDate'];?></td>
                            <td><?php echo $row['SemesterEndDate'];?></td>
                            <td><?php echo $row['SeatCount'];?></td>
                            <td>
                                <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_semester_calendar/<?php echo $row['id'];?>');">
                                    <i class="entypo-pencil"></i>
                                    <?php echo get_phrase('edit');?>
                                </a>
                                &nbsp;  &nbsp;  &nbsp;
                                <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/semester_calendar/delete/<?php echo $row['id'];?>');">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?admin/semester_calendar/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                    <div class="padded">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="datepicker form-control" name="SemesterStartDate"/>
                            </div>
                        </div>
                        <div class="form-group">
                            <label class="col-sm-3 control-label"><?php echo get_phrase('semester_end_date');?></label>
                            <div class="col-sm-5">
                                <input type="text" class="datepicker form-control" name="SemesterEndDate"/>
                            </div>
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            <div class="col-sm-offset-3 col-sm-5">
                                <button type="submit" class="btn btn-info"><?php echo get_phrase('add_semester_calendar');?></button>
                            </div>
                        </div>
                        </form>
                    </div>
