            ...
            <div class="tab-pane box active onad" id="list">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <tr>
                        ...
                        <th><div><?php echo get_phrase('previous_exam_marks');?></div></th>
                        <th><div><?php echo get_phrase('admission_marks');?></div></th>
                        <th><div><?php echo get_phrase('total_marks');?></div></th>
                        <th><div><?php echo get_phrase('merit_position');?></div></th>
                    ...
                    <?php $count = 1;foreach($osadStudent as $row):?>
                        <tr>
                            ...
                            <td><img src="<?php echo base_url()."assets/images/applicants/".$row['photo'];?>" class="img-circle" width="30" /></td>
                            <td><?php echo $row['register_number'];?></td>
                            <td><?php echo $row['name_en'];?></td>
                            <td><?php echo $row['total_gpa'];?></td>
                            <td><?php echo $row['admission_marks'];?></td>
                            <td><?php echo $row['total_marks'];?></td>
                            <td><?php echo $row['merit_position'];?></td>
                            <td>
                                <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_student_management/<?php echo $row['id'];?>');">
                                    <i class="entypo-pencil"></i>
                                    <?php echo get_phrase('edit');?>
                                </a>
                                &nbsp;  &nbsp;  &nbsp;
                                <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_student_management_profile/<?php echo $row['id'];?>');">
                                    <i class="entypo-pencil"></i>
                                    <?php echo get_phrase('profile');?>
                                </a>
                                &nbsp;  &nbsp;  &nbsp;
                                <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/student_management/delete/<?php echo $row['id'];?>');">
