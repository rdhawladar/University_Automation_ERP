        ...
        <div class="tab-content">
                ...
                <table class="table table-bordered datatable" id="table_export">
                    ...
                    <?php $count = 1;foreach($acdSession as $row):?>
                        <tr>
                            ...
                            <td>
                                <a href="#" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/modal_edit_elective_subject/<?php echo $row['id'];?>');">
                                    <i class="entypo-pencil"></i>
                                    <?php echo get_phrase('edit');?>
                                </a>
                                &nbsp;  &nbsp;  &nbsp;
                                <a href="#" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/elective_subject/delete/<?php echo $row['id'];?>');">
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
                    <?php echo form_open(base_url() . 'index.php?admin/elective_subject/create' , array('class' => 'form-horizontal form-groups-bordered validate','target'=>'_top'));?>
                    <div class="padded">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-5">
                                <?php
                                $faculty_setup = $this->db->get('student')->result_array();
                                foreach($faculty_setup as $row):
                                    ?>
                                    <input type="checkbox" name="students[]" value="<?php echo $row['name'];?>">
                                    &nbsp;&nbsp;
                                    <?php echo $row['name'];?>
                                    <br/>
                                    <?php
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-3 col-sm-5">
                            <button type="submit" class="btn btn-info"><?php echo get_phrase('add_elective_subject');?></button>
                        </div>
                    </div>
                    </form>
                </div>
