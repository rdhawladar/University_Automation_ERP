                    ...
                    <form id="search_form" name="frmEmployeeSearch" method="post" action="/hrm/symfony/web/index.php/pim/viewEmployeeList">
                        <fieldset>
                            <ol>
                                ...
                                <li><label for="empsearch_employee_name">Barred</label>
                                    <select name="" id="" class="form-control">
                                        <option value="">Please Select</option>
                                ...
                                <li><label for="empsearch_employee_name">Foreign Students</label>
                                    <select name="" id="" class="form-control">
                                        <option value="">Please Select</option>
                                        <option value="">Yes</option>
                                        <option value="">No</option>
                        ...
                        <div id="tableWrapper">
                            <table class="table hover" id="resultTable">
                                ...
                                <tr>
                                    ...
                                    <th rowspan="1" style="width:13%" class="header"><a href="#firstMiddleName&amp;sortOrder=ASC" class="null">Full Name</a></th>
                                    ...
                                    <th rowspan="1" style="width:20%" class="header"><a href="#jobTitle&amp;sortOrder=ASC" class="null">Barred</a></th>
                                    <th rowspan="1" style="width:20%" class="header"><a href="#jobTitle&amp;sortOrder=ASC" class="null">Foreign</a></th>
                                            ...
                                            <div class="profile-env">
                                                ...
                                                <section class="profile-info-tabs">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="">
                                                            <br>
                                                            Financial Information Will go here..
                                                        </div>
                                                    </div>
                                                </section>
                                            </div>
