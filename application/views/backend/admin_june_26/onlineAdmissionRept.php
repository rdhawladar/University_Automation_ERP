...
<div style="    clear: both;    width: 100%;    float: right;    text-align: right;    margin-right: 100px;">
	<a href="javascript:window.print()"><img src="./assets/images/print.png" alt="print this page" id="print-button" /></a>
</div>
