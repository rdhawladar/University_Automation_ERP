...
<link rel="stylesheet" href="assets/css/EdusecCustom.css">
...
<script src="<?php echo base_url();?>assets/js/print/print21.css" type="text/javascript"></script>
<script src="<?php echo base_url();?>assets/js/print/Style21.css" type="text/javascript"></script>
