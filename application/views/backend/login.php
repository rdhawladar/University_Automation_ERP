...
<div class="login-container">
	...
	<div class="login-header login-caret">
		...
		<div class="login-content" style="width:100%;">
			...
			<A href="<?php echo base_url();?>" class="logo">
				<img src="uploads/logopundro.png" height="" alt="" />
			</A>

			<p class="description">
            	<h2 style="color:chocolate; font-weight:100;">
					<?php //echo $system_name;?>
                </h2>
           </p>
			<p>
				<h3 style="color: blueviolet;font-size: 22px;font-style: italic;">
	...
	<div class="login-form">
		...
		<div class="login-content">
			...
			<div class="login-bottom-links" style="display:none;">
...
<div class="panel panel-primary" style="display:none;background-color:rgba(255, 255, 255, 0);border-color: rgba(235, 235, 235, 0.14);">
...
<div class="copyrightnew">© 2016 All rights Reserved by<a target="_blank" href="http://tmss-ict.com/">TMSS-ICT</a></div>
</div>
