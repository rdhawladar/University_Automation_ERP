<div class="sidebar-menu">
    ...
    <ul id="main-menu" class="">
        ...
        <li class="<?php if ($page_name == 'announcements') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?parents/announcements">
                <i class="entypo-gauge"></i>
                <span><?php echo get_phrase('announcements'); ?></span>
            </a>
        </li>
        <li class="<?php if ($page_name == 'calendar') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?parents/calendar">
                <i class="entypo-gauge"></i>
                <span><?php echo get_phrase('calendar'); ?></span>
            </a>
        </li>
        <li class="<?php if ($page_name == 'tasks') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?parents/tasks">
                <i class="entypo-gauge"></i>
                <span><?php echo get_phrase('tasks'); ?></span>
            </a>
        </li>
        <li style="display:none;" class="<?php if ($page_name == 'my_settings') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?parents/my_settings">
                <i class="entypo-gauge"></i>
                <span><?php echo get_phrase('my_settings'); ?></span>
            </a>
        </li>
        <li class="<?php if ($page_name == 'observer_dashboard') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?parents/observer_dashboard">
                <i class="entypo-gauge"></i>
                <span><?php echo get_phrase('observer_dashboard'); ?></span>
            </a>
        </li>
        <li class="<?php if ($page_name == 'goals') echo 'active'; ?> ">
            <a href="<?php echo base_url(); ?>index.php?parents/goals">
                <i class="entypo-gauge"></i>
                <span><?php echo get_phrase('goals'); ?></span>
            </a>
        </li>
        ...
        <!-- CLASS ROUTINE -->
        <li style="display:none;" class="<?php if ($page_name == 'class_routine') echo 'opened active';?> ">
            <a href="#">
        ...
        <!-- PAYMENT -->
        <li style="display:none;" class="<?php if ($page_name == 'invoice') echo 'opened active';?> ">
            <a href="#">
        ...
        <!-- NOTICEBOARD -->
        <li style="display:none;" class="<?php if ($page_name == 'noticeboard') echo 'active'; ?> ">
        ...
        <!-- MESSAGE -->
        <li style="display:none;" class="<?php if ($page_name == 'message') echo 'active'; ?> ">
