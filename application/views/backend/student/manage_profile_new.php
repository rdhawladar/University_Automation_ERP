                            ...
                            <div class="col-md-6">
                                ...
                                <tr><td><label>Certificate/Degree
                                            <select class="form-control" name="CertificateName1" id="CertificateName1">
                                                ...
                                                $assas221 = $this->db->get('certificate_name')->result_array();
                                                foreach($assas221 as $ssrow334221):
                                                    ?>
                                                    <option value="<?php echo $ssrow334221['id'];?>"><?php echo $ssrow334221['Name'];?></option>
                                                    <?php
                                                endforeach;
                                                ?>
                                                <?php
                                    ...
                                    <td><label>Group/Discipline
                                            <select class="form-control" name="CertificateGroup1" id="CertificateGroup1">
                                                ...
                                                $assas22121a = $this->db->get('certificate_group')->result_array();
                                                foreach($assas22121a as $ssrow33422121a):
                                                    ?>
                                                    <option value="<?php echo $ssrow33422121a['id'];?>"><?php echo $ssrow33422121a['Name'];?></option>
                                                    <?php
                                                endforeach;
                                                ?>
                                                <?php
                                    ...
                                    <td><label>Year of Passing
                                            <select class="form-control" name="CertificateYear1" id="CertificateYear1">
                                                ...
                                                $assas22121aa = $this->db->get('year_calendar')->result_array();
                                                foreach($assas22121aa as $ssrow33422121aa):
                                                    ?>
                                                    <option value="<?php echo $ssrow33422121aa['id'];?>"><?php echo $ssrow33422121aa['Name'];?></option>
                                                    <?php
                                                endforeach;
                                                ?>
                                                <?php
                                ...
                                <table>
                                    <tr><td><label>Certificate/Degree
                                                <select class="form-control" name="CertificateName2" id="CertificateName2">
                                                    ...
                                                    $assas2212 = $this->db->get('certificate_name')->result_array();
                                                    foreach($assas2212 as $ssrow3342212):
                                                        ?>
                                                        <option value="<?php echo $ssrow3342212['id'];?>"><?php echo $ssrow3342212['Name'];?></option>
                                                        <?php
                                                    endforeach;
                                                    ?>
                                                    <?php
                                        ...
                                        <td><label>Group/Discipline
                                                <select class="form-control" name="CertificateGroup2" id="CertificateGroup2">
                                                    ...
                                                    $assas22121 = $this->db->get('certificate_group')->result_array();
                                                    foreach($assas22121 as $ssrow33422121):
                                                        ?>
                                                        <option value="<?php echo $ssrow33422121['id'];?>"><?php echo $ssrow33422121['Name'];?></option>
                                                        <?php
                                                    endforeach;
                                                    ?>
                                                    <?php
                                        ...
                                        <td><label>Year of Passing
                                                <select class="form-control" name="CertificateYear2" id="CertificateYear2">
                                                    ...
                                                    $assas22121aaa = $this->db->get('year_calendar')->result_array();
                                                    foreach($assas22121aaa as $ssrow33422121aaa):
                                                        ?>
                                                        <option value="<?php echo $ssrow33422121aaa['id'];?>"><?php echo $ssrow33422121aaa['Name'];?></option>
                                                        <?php
                                                    endforeach;
                                                    ?>
                                                    <?php
                                        ...
                                        <td><label>Institute/Board <input type="text" value="<?php echo $row['CertificateNameofInstitute2']?>" name="CertificateNameofInstitute2" id="CertificateNameofInstitute2"/></label></td>
