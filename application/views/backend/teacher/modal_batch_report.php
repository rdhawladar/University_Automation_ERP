            ...
            <table>
                    ...
                    <tr>
                        ...
                        <tr>
                            ...
                            <?php } ?>
                            <td><div>Total Class</div></td>
                            <td><div>Total Present</div></td>
                            <td><div>Total Absent</div></td>
                            <td><div>Present Ratio</div></td>
                            <td><div>Absent Ratio</div></td>
                        </tr>
                        </table>
                        </td>
                        <?php } ?>
            ...
            <table>
                    ...
                    <tr>
                        ...
                        <?php
                            ...
                            $count = 1;foreach($as as $row334):
                        ?>
                            <tr>
                                <td><div><?php echo $count++;?></div></td>
                                <td><div>
                                    <?php echo $row12['StudentID'];?></div>
                                </td>
                                <td><div><?php echo $row334['NameofApplicant'];?></div></td>
                                <?php
                                ...
                                <td><div>
                                    <?php echo $total_class = $this->db->get('attendance_pundro')->num_rows();?></div>
                                </td>
                                <td><div>
                                    <?php
                                ...
                                <td><div>
                                    <?php echo $absent_status = $total_class - $total_attend;?></div>
                                </td>
                                <td><div>
                                    <?php 
                                        $ratio_present = (($total_attend/$total_class)*100); 
                                        echo $result = substr($ratio_present, 0, 5);
                                        echo "%";
                                    ?></div>
                                </td>
                                <td><div>
                                    <?php
                                        $ratio_absent = (100 - $ratio_present);
                                        echo $result = substr($ratio_absent, 0, 5);
                                        echo "%";
                                    ?></div>
                                </td>
                            </tr>
