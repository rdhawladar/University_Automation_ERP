...
<body>
    <div class="container">
       <div class="row row5" id="form_chart">
            <div class="col-md-12">
            <img src="images/" id="tmss_logo1" alt="" style=";" class="img-responsive"/>

            <div id="head_text_area" style="">
                <h2 style="text-align:center;">PUNDRO UNIVERSITY OF SCIENCE & TECHNOLOGY</h2>
                <h3 style="text-align:center;">BOGURA, BOGURA</h3>
                <h4 style="text-align:center;">Admission Form</h4>
            </div>
                <h3>Course Information</h3>
                <hr>

                <form action="registration.php" method="GET" onsubmit="javascript:return regform()">
                        <div class="form-inline">
                        <div class="form-group">
                        <label for="" style="margin-right:45px;">Applied for:</label>
                        <select name="org_name" id="org_name" class="form-control" onclick="erase_org_name()">
                            <option value="">Select One</option>
							<option value="ScienceAndEngineering">Graduation</option>
							<option value="BusinessStudies">Post Graduation</option>
                        ...
                        <select name="course_name" id="course_name" class="form-control" onclick="erase_course_name()">
                                     <option value="" >Select Faculty </option>
									<option value="CSE">Science & Engineering</option>
                        ...
                        <div class="form-inline" >
                            ...
                            <select name="training_venue" id="training_venue" class="form-control" onclick="erase_training_venue_error()">
                        ...
                        <h3>Applicant's Information</h3>
                         ...
                         <div class="form-group" id="birth_cirtificate_group" style="">
                            ...
                            <input type="text" name="birth_cirtificate_no" id="birth_cirtificate_no" class="form-control" onclick=""/>
                         ...
                         <div class="form-group">
                            ...
                            <input type="text" name="birthday" id="birthday"  class="form-control b_date" onclick="erase_birth_date_error()"/>
                         ...
                         <div class="form-group">
                           <label for="">Division</label><br>
                            <select name="present_address_division" id="present_address_division" class="form-control" onclick="erase_present_address_division_error()">
                         ...
                         <br>
                           ...
                           <hr>
                            <table class="table-responsive" style="width:100%;">
                                  ...
                                  <tr>
                                    ...
                                    <td>
												...
												<input type="text" name="ssc_result" placeholder="above 4.5" class="form-control" onclick="erase_parmanent_police_station_error()"/>
											
                                            <p style="" id="result_exam_1_error"></p>
                                    </td>
                                    <td>
                                            <select name="ssc_board" id="board_exam_1" class="form-control" onclick="erase_board_exam_1_error()">
												<option value="">Select</option>
												<option value="Dhaka">Dhaka</option>
												<option value="Chittagong">Chittagong</option>
                                  ...
                                  <tr>
                                    ...
                                    <td>
                                        <input type="text" name="institute_name_exam_2" id="institute_name_exam_2" class="form-control" onclick="erase_institute_name_exam_2_error()">
                                        <p style="" id="institute_name_exam_2_error"></p>
                                    </td>
                                    <td>
                                        
												<input type="text" name="hsc_result" placeholder="above 4.00" class="form-control" onclick="erase_result_exam_2_error()"/>
											
                                            <p style="" id="result_exam_2_error"></p>
                                    </td>
                                    <td>
                                        <select name="board_exam_2" id="board_exam_2" class="form-control" onclick="erase_board_exam_2_error()">
												<option value="">Select</option>
												<option value="Dhaka">Dhaka</option>
												<option value="Chittagong">Chittagong</option>
												<option value="Comilla">Comilla</option>
                            ...
                            <br>
                              <div class="form-inline">
                                <div class="form-group">
                                    <label style="margin-right:42px;">Ethnic Group<br>(optional)</label>
                              ...
                              <div class="form-inline">
                                <div class="form-group">
                                    <label style="margin-right:61px;">Nationality</label>
                            ...
                            <p style="margin-left:124px;" id="country_error"></p>
                              ...
                              <br><br>
							  <label for="" style="margin-right:20px;">Submit your image:</label>
                              <div style="text-align:center;">
							  <input type="file" value="image" name="photo" class="btn btn-primary"/>
							  <input type="submit" value="Submit" class="btn btn-primary"/>
                              <input type="reset" value="New Form" class="btn btn-danger"/> </div>
                </form>
                <br>
            </div>
