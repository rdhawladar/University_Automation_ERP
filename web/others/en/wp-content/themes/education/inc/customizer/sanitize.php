...
if ( ! function_exists( 'education_hub_sanitize_select_liberal' ) ) :
	 ...
	 * @return mixed Sanitized value.
	 */
	function education_hub_sanitize_select_liberal( $input, $setting ) {
...
if ( ! function_exists( 'education_hub_sanitize_positive_integer' ) ) :
	 ...
	 */
	function education_hub_sanitize_positive_integer( $input, $setting ) {
...
if ( ! function_exists( 'education_hub_sanitize_dropdown_pages' ) ) :
	 ...
	 */
	function education_hub_sanitize_dropdown_pages( $page_id, $setting ) {
...
if ( ! function_exists( 'education_hub_sanitize_image' ) ) :
	 ...
	 */
	function education_hub_sanitize_image( $image, $setting ) {
...
if( ! function_exists( 'education_hub_customize_callback_reset_all_settings' ) ):
   ...
   */
  function education_hub_customize_callback_reset_all_settings( $input ){
